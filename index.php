...
<body>
    ...
    <table>
        ...
        $records = [
            ...
            ['2025-1-31', 5000, 104282, 0.00659],
            ['2025-2-26', 5000, 86810, 0.00783],
            ['2025-3-29', 5000, 83785, 0.00824],
	    ['2025-4-30', 5000, 94911, 0.00721],
	    ['2025-5-31', 5000, 104173, 0.00665],
	    ['2025-6-30', 5000, 107643, 0.0065],
	    ['2025-7-31', 5000, 118600, 0.00593],
	    ['2025-9-1', 5000, 109058, 0.00642],
	    ['2025-9-30', 5000, 114267, 0.00614],
	    ['2025-11-3', 5000, 107488, 0.00656],
	    ['2025-12-1', 5000, 86999, 0.00819],
        ];
